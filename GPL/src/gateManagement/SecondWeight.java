...
public class SecondWeight {
		...
		public static String S_09_B(String[] loc, String[] value) 
		{
			return status=Reusable.Entertext(loc, value);
			
		}
		public static String S_09_BB(String[] loc, String[] value) 
		{
			return status=Reusable.Entertext(loc, value);
			
		}
		public static String S_09_P(String[] loc, String[] value) 
		{
			return status=Reusable.Entertext(loc, value);
			
		}
		public static String S_09_E(String[] loc, String[] value) 
		{
			return status=Reusable.Entertext(loc, value);
		...
		public static String S_12(String[] noloc, String[] novalue)
		{
		...
		public static String S_15(String[] noloc, String[] novalue)
		{
			Reusable.IsAlertPresent();
			return status="pass";
...
/*public static String S_04(String[] listloc, String[] listvalue) throws InterruptedException
		...
		//entertextclick
		public String S_07(String[] loc, String[] noelement) throws InterruptedException
		{
		return status=Reusable.entertextclick(loc, noelement);
