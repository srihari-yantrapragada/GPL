...
public String Task_name,SubTask_Name,ScenariosTest;
...
//--if condition satisfies enter into form module-------------------------------------------------------------------------------------------------------------------------- 			
	 			...
	 			ScenariosTest=sform.getCell(11, c).getContents();
	 			
	 			System.out.println("Scenarios are :  "+ScenariosTest);
	 			List<String> list = new ArrayList<String>();
	 			
	 			String s_id[]=ScenariosTest.split(",");
	 			for(String scenariosTest : s_id)
	 			{
	 				System.out.println(scenariosTest);
	 				list.add(scenariosTest);
	 			}
	 			
	 			 finalTesCaseStatus=ReadWriteExcel.sendFormName(Task_name+"."+SubTask_Name+"."+PModuleName+"."+formname,list);//6
